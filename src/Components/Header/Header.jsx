  ...
  let submenu = [
      ...
      categories: [
        ...
        },
        {
          ...
          items: [
            ...
            "سرویس غذاخوری",
            "قاشق، چنگال و کارد",
            "زیرلیوانی، زیر بشقابی و زیر قابلمه ای",
            "ابزار مهمانی",
          ],
        },
        {
    ...
    },
    {
      ...
      categories: [
        ...
        {
          title: "جاروبرقی",
          items: ["جارو شارژی", "لوازم جانبی جاروبرقی و بخارشور"],
        },
        {
          title: "بخار شو",
          items: [],
    ...
    },
    {
      ...
      categories: [
        ...
        {
          title: "آجیل",
          items: ["فندق", "پسته", "بادام زمینی", "بادام هندی", "انجیر"],
        },
        {
          title: "شیرینی",
        ...
        {
          title: "چای و دمنوش",
          items: ["چای سبز", "چای سیاه", "دمنوش", "چای ماسالا"],
        },
        {
          title: "قهوه",
    ...
    },
    {
      ...
      categories: [
        ...
        { title: "غذاخوری", items: ["صندلی غذاخوری", "شیشه شیر"] },
        {
        ...
        { title: "تبلت", items: [] },
        { title: "پلی استیشن، ایکس باکس و بازی", items: [] },
        {
          title: "اسباب بازی",
          items: [
            "فکری و آموزشی",
    ...
    },
    {
      ...
      categories: [
        { title: "حفاظتی و امنیتی", items: ["گاوصندوق", "قفل"] },
        {
      ...
      categories: [
        {
          ...
          items: ["لوازم مصرفی", "لوازم یدکی", "لوازم جانبی", "لوازم ضد سرقت"],
        },
        {
    ...
    },
    {
      ...
      categories: [
        { title: "اکسسوری و زیورآلات دست ساز", items: [] },
        { title: "پوشاک بومی و محلی", items: [] },
        { title: "قالی و قالیچه", items: [] },
        {
          title: "ظروف سنتی",
          items: [
            "آجیل خوری سنتی",
        ...
        },
        {
          ...
          items: ["سبد دستبافت", "هاون سنتی", "تخته سرو دست ساز"],
        },
        { title: "رومیزی، رانر و زیربشقابی سنتی", items: [] },
        {
          title: "دکوراتیو سنتی",
          items: [
        ...
        { title: "خانه و کاشانه", items: [] },
        {
          title: "نوشیدنی های ارگانیک",
          items: ["چای ارگانیک ایرانی", "دمنوش گیاهی"],
        },
        { title: "خشکبار و آجیل سنتی", items: ["آجیل سنتی", "خرمای محلی"] },
        {
        ...
        { title: "عطاری", items: [] },
        { title: "ترشیجات و شور خانگی", items: [] },
        { title: "مواد غذایی ارگانیک", items: [] },
        { title: "خواروبار محلی", items: ["برنج محلی", "روغن محلی"] },
        {
          title: "صبحانه محلی",
          items: ["عسل طبیعی", "حلوا شکری، ارده و کنجد سنتی"],
        },
        {
        ...
        { title: "لبنیات سنتی", items: ["کره گیاهی و حیوانی محلی"] },
      ],
    },
  ];
