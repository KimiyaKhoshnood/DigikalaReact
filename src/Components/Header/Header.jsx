      ...
      <header className="sticky top-0 z-20 bg-white">
        ...
        {header ? (
          <nav className="h-[40px] lg:flex hidden justify-between px-2">
                  ...
                  >
                    {header?.submenu.map((section, i) => {
                      return (
                        ...
                        >
                          <h3 className="py-2 text-cyan-600">
                          ...
                          <div className="flex flex-col flex-wrap max-h-[1300px]">
                            {section.categories.map((column) => {
                              return (
                                <div className="h-fit">
                                  <span className="text-sm block py-3 hover:text-rose-700">
                                  ...
                                  <div className="flex flex-col">
                                    {column?.items.map((items) => {
                                      return (
                                        <span className="px-1 py-2 text-gray-500 hover:text-rose-700">
                                          {" "}
                                          {items}{" "}
                                        </span>
                                      );
            ...
            <div onClick={()=>m} className="bg-orange-50 rounded-3xl">
              <NavbarItems
