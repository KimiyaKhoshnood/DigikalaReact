        ...
        <div className='flex max-w-[1636px] w-full'>
            ...
            <div className='flex flex-col gap-3'>
                ...
                <form className='flex gap-2' action="">
                    <input className='bg-gray-100 text-gray-100 flex-1 p-3 rounded-md w-[260px]' type="text" placeholder='ایمیل شما'/>
        ...
        <div className='flex py-10 gap-5 max-w-[1636px] w-full'>
            <div className='flex-1'>
                <div className='bg-gradient-to-b from-white to-white/50'>
                    ...
                    {
                        readMore?FooterP.info.map((elem)=>{
                            return <p className='text-xs text-gray-500 leading-loose'>{elem}</p>
                        }): <p className='text-xs text-gray-500 leading-loose line-clamp-3'>{FooterP.info[0]}<br/>{FooterP.info[1]}</p>
                    }
                    </div>
                </div>
