...
const Header = () => {
  let NavbarItemsP = {
    productSorting: { text: "دسته‌بندی کالاها", icon: bars, size: "text-md", id: 1 },
    digikalaPagesNavbar: [
      {
        text: "شگفت‌انگیزها",
        icon: bars,
        ...
        <div className="px-3 flex lg:hidden flex-col gap-2 py-2">
            <div className="flex justify-between">
                <div className="flex gap-2 items-center">
                    ...
                    <img className="w-[32px] h-[32px]" src="https://www.digikala.com/statics/img/png/Logo.webp" alt="" />
                    <span>اپلیکیشن دیجی‌کالا</span>
                </div>
                <a className="h-[36px] px-3 rounded-lg flex items-center bg-black text-white text-[12px]" href="">نصب</a>
            </div>
            <div className="w-full h-[40px] bg-[#F0F0F1] rounded-3xl flex gap-2 items-center px-2">
                ...
                <img className="h-[16px]" src="https://www.digikala.com/brand/typography.svg" alt="" />
            </div>
        </div>
